...
import { LayoutDashboard, Boxes, Activity, GitBranch, ShieldAlert, PlusCircle, ArrowLeftRight, Network, FlaskConical, Tag, Database, Thermometer } from "lucide-react";
import {
  Sidebar,
  SidebarContent,
  SidebarGroup,
...
const main = [
  ...
  { title: "Taxonomy / Tags", url: "/taxonomy", icon: Tag },
